...
import Qrscan from '../../../assets/img/portalTable/qrscan.png';
import AddQrCodeModal from 'theme/components/addQrCodeModal/AddQrCodeModal';
...
const QrCode = () => {
	...
	// Data
	const dummyDataHeader = ['Code', 'Type', 'Last Activity', 'Category'];
	...
	return (
		<>
			...
			<AddQrCodeModal isOpen={modalShow} setIsOpen={setModalShow}
				// qrCodeValue={qrCodeValue} setQrcodeValue={setQrCodeValue}
				dummyDataHeader={dummyDataHeader} dummyDataToShow={dummyDataToShow}
				currentData={currentData} name="QrCode"
			/>
						...
						<CardHeader>
							<CardLabel>
								<CardTitle style={{ display: 'flex', alignItems: 'center' }}>
									<img src={Qrscan} style={{ width: '28px', marginRight: '12px' }} alt='qrCodes' />
									Qr Code{' '}
