...
import BarCodes from '../../../assets/img/portalTable/barcode.png';
import AddBarCodeModal from 'theme/components/AddBarCodeModal/AddBarCodeModal';
...
const BarCode = () => {
	...
	// Data
	const dummyDataHeader = ['Code', 'Type', 'Last Activity'];
	...
	// Bar Code Modal State
	const [indexValue, setIndexValue] = useState(0)
	return (
		<>
			<AddBarCodeModal isOpen={modalShow} setIsOpen={setModalShow}
				// barcodeValue={barcodeValue} setBarcodeValue={setBarcodeValue}
						...
						<CardHeader>
							<CardLabel>
								<CardTitle style={{ display: 'flex', alignItems: 'center' }}>
									<img src={BarCodes} style={{ width: '28px', marginRight: '12px' }} alt='BarCodes' />
									Bar Code{' '}
