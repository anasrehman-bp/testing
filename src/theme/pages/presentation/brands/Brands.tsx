...
import Brand from '../../../assets/img/portalTable/brand.png';
...
const Brands = () => {
	...
	const handleDeleteBrands = (value: any) => {
		console.log("Delete Brands", value);
	}

	const [currentData, setCurrentData] = useState<any>(null);

	return (
		<PageWrapper title={layoutMenu.brands.text}>
			<SubHeader>
				<SubHeaderRight>
				...
				<Card stretch data-tour='list'>
					<CardHeader>
						<CardLabel>
							<CardTitle style={{ display: 'flex', alignItems: 'center' }}>
								<img src={Brand} style={{ width: '28px', marginRight: '12px' }} alt='Brand' />
								Brands{' '}
					...
					<CardBody className='table-responsive' isScrollable>
						...
						<TableComponent
							...
							handleDeleteInvitation={handleDeleteBrands}
						/>
					</CardBody>
					<PaginationButtons
						data={items}
