...
// import SubHeader, {SubHeaderLeft,SubHeaderRight,SubheaderSeparator,
...
// 	return (
// 		<PageWrapper title={layoutMenu.listPages.subMenu.boxedList.text}>
// 			<SubHeader>
// 				<SubHeaderRight>
